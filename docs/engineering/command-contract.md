...
| `./eng/test.sh` | Fast test execution | No benchmarks |
...
| Script | Purpose |
| --- | --- |
| `./eng/ci/collect-coverage.sh` | Re-run repository test projects with coverage for standard or performance workflows |
